...
<div id="muMi_search2">
<form class="search-form" action="userMSearch.do" method="get">
...
<div class="return-form">
	<div class="return" onclick="location.href='userMission.do?login_no=${loginMember.u_no}&page=1'">
		<svg class="edit-pen-title">
...
<ul class="pagination modal-3">
  ...
  <c:if test="${requestScope.currentPage gt 1}">
  	<li><a href="userMission.do?login_no=${loginMember.u_no}&page=1" class="first">first</a></li>
  </c:if>
  	<!-- 이전버튼 &lt-->
  ...
  <c:if test="${(currentPage - 10) lt startPage and (currentPage - 10) gt 1}">
  	<li><a href="userMission.do?login_no=${loginMember.u_no}&page=${requestScope.startPage - 10}" class="prev">&laquo</a></li>
  </c:if>
  <!-- 숫자버튼 &lt-->
  <c:forEach var="p" begin="${requestScope.startPage}" end="${requestScope.endPage}" step="1">
  	...
  	<c:if test="${p ne requestScope.currentPage}">
  		<li><a href="userMission.do?login_no=${loginMember.u_no}&page=${p}" class="current">[${p}]</a></li>
  	</c:if>
  </c:forEach>
...
<!--   <li> <a href="#">2</a></li>
  ...
  <c:if test="${(currentPage + 10) gt endPage and (currentPage + 10) lt maxPage}">
  	<li><a href="userMission.do?login_no=${loginMember.u_no}&page=${requestScope.endPage + 10}" class="next">&raquogt;</a></li>
  </c:if>
<!--   <li><a href="#" class="next">&raquo;</a></li> -->
  ...
  <c:if test="${currentPage lt maxPage}">
  	<li><a href="userMission.do?login_no=${loginMember.u_no}&page=${requestScope.maxPage}" class="last">last</a></li>
  </c:if>
